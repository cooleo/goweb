...
//		"github.com/cooleo/goweb/plugins/apiauth"
//	)
//
//	func main(){
//		// apiauth every request
//		goweb.InsertFilter("*", goweb.BeforeRouter,apiauth.APIBaiscAuth("appid","appkey"))
//		goweb.Run()
//	}
//
// Advanced Usage:
...
//	}
//
//	goweb.InsertFilter("*", goweb.BeforeRouter,apiauth.APISecretAuth(getAppSecret, 360))
//
// Information:
//
...
func APIBaiscAuth(appid, appkey string) goweb.FilterFunc {
...
func APISecretAuth(f AppIDToAppSecret, timeout int) goweb.FilterFunc {
