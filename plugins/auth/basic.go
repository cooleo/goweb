...
//		"github.com/cooleo/goweb/plugins/auth"
//	)
//
//	func main(){
//		// authenticate every request
//		goweb.InsertFilter("*", goweb.BeforeRouter,auth.Basic("username","secretpassword"))
//		goweb.Run()
//	}
//
//
...
//		return username == "cooleo" && password == "hellogoweb"
//	}
//	authPlugin := auth.NewBasicAuthenticator(SecretAuth, "Authorization Required")
//	goweb.InsertFilter("*", goweb.BeforeRouter,authPlugin)
package auth
...
func Basic(username string, password string) goweb.FilterFunc {
...
func NewBasicAuthenticator(secrets SecretProvider, Realm string) goweb.FilterFunc {
