...
//			return false
//	 	}
//	 	if strings.HasPrefix(requestPath, "/cooleo") {
//			return false
//	 	}
//	 	return true
// 	}
// 	goweb.FilterMonitorFunc = MyFilterMonitor.
...
// ListConf is the http.Handler of displaying all goweb configuration values as key/value pair.
...
func printTree(resultList *[][]string, t *Tree) {
	...
	for _, l := range t.leaves {
		if v, ok := l.runObject.(*controllerInfo); ok {
			if v.routerType == routerTypegoweb {
				var result = []string{
					v.pattern,
