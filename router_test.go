...
func TestUrlFor2(t *testing.T) {
	...
	if handler.URLFor("TestController.GetURL", ":username", "cooleo") != "/v1/cooleo/edit" {
		Info(handler.URLFor("TestController.GetURL"))
		t.Errorf("TestController.List must equal to /v1/cooleo/edit")
	}
...
func TestPostFunc(t *testing.T) {
	r, _ := http.NewRequest("POST", "/cooleo", nil)
	w := httptest.NewRecorder()

	handler := NewControllerRegister()
	handler.Add("/:name", &TestController{})
	handler.ServeHTTP(w, r)
	if w.Body.String() != "cooleo" {
		t.Errorf("post func should cooleo")
	}
}
...
func TestManyRoute(t *testing.T) {
	...
	r, _ := http.NewRequest("GET", "/goweb32-12.html", nil)
	w := httptest.NewRecorder()

	handler := NewControllerRegister()
	handler.Add("/goweb:id([0-9]+)-:page([0-9]+).html", &TestController{}, "get:GetManyRouter")
	handler.ServeHTTP(w, r)
...
func TestEmptyResponse(t *testing.T) {
	...
	r, _ := http.NewRequest("GET", "/goweb-empty.html", nil)
	w := httptest.NewRecorder()

	handler := NewControllerRegister()
	handler.Add("/goweb-empty.html", &TestController{}, "get:GetEmptyBody")
	handler.ServeHTTP(w, r)
...
func gowebFilterFunc(ctx *context.Context) {
...
func TestRouterFunc(t *testing.T) {
	...
	mux.Get("/action", gowebFilterFunc)
	mux.Post("/action", gowebFilterFunc)
...
func TestFilterBeforeRouter(t *testing.T) {
	...
	mux := NewControllerRegister()
	mux.InsertFilter(url, BeforeRouter, gowebBeforeRouter1)

	mux.Get(url, gowebFilterFunc)
...
func TestFilterBeforeExec(t *testing.T) {
	...
	mux := NewControllerRegister()
	mux.InsertFilter(url, BeforeRouter, gowebFilterNoOutput)
	mux.InsertFilter(url, BeforeExec, gowebBeforeExec1)
...
func TestFilterAfterExec(t *testing.T) {
	...
	mux := NewControllerRegister()
	mux.InsertFilter(url, BeforeRouter, gowebFilterNoOutput)
	mux.InsertFilter(url, BeforeExec, gowebFilterNoOutput)
	mux.InsertFilter(url, AfterExec, gowebAfterExec1, false)
...
func TestFilterFinishRouter(t *testing.T) {
	...
	mux.InsertFilter(url, BeforeRouter, gowebFilterNoOutput)
	mux.InsertFilter(url, BeforeExec, gowebFilterNoOutput)
	mux.InsertFilter(url, AfterExec, gowebFilterNoOutput)
	mux.InsertFilter(url, FinishRouter, gowebFinishRouter1)
...
func TestFilterFinishRouterMultiFirstOnly(t *testing.T) {
	...
	mux := NewControllerRegister()
	mux.InsertFilter(url, FinishRouter, gowebFinishRouter1, false)
	mux.InsertFilter(url, FinishRouter, gowebFinishRouter2)
...
func TestFilterFinishRouterMulti(t *testing.T) {
	...
	mux := NewControllerRegister()
	mux.InsertFilter(url, FinishRouter, gowebFinishRouter1, false)
	mux.InsertFilter(url, FinishRouter, gowebFinishRouter2, false)
...
func gowebFilterNoOutput(ctx *context.Context) {
	return
}
func gowebBeforeRouter1(ctx *context.Context) {
	ctx.WriteString("|BeforeRouter1")
}
func gowebBeforeRouter2(ctx *context.Context) {
	ctx.WriteString("|BeforeRouter2")
}
func gowebBeforeExec1(ctx *context.Context) {
	ctx.WriteString("|BeforeExec1")
}
func gowebBeforeExec2(ctx *context.Context) {
	ctx.WriteString("|BeforeExec2")
}
func gowebAfterExec1(ctx *context.Context) {
	ctx.WriteString("|AfterExec1")
}
func gowebAfterExec2(ctx *context.Context) {
	ctx.WriteString("|AfterExec2")
}
func gowebFinishRouter1(ctx *context.Context) {
	ctx.WriteString("|FinishRouter1")
}
func gowebFinishRouter2(ctx *context.Context) {
