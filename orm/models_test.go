...
type Post struct {
	...
	Updated time.Time `orm:"auto_now"`
	Tags    []*Tag    `orm:"rel(m2m);rel_through(github.com/cooleo/goweb/orm.PostTags)"`
}
...
type Permission struct {
	ID     int `orm:"column(id)"`
	Name   string
	Groups []*Group `orm:"rel(m2m);rel_through(github.com/cooleo/goweb/orm.GroupPermissions)"`
}
...
go get -u github.com/cooleo/goweb/orm
...
go test -v github.com/cooleo/goweb/orm
