...
//
// depend on github.com/goweb/goyaml2
//
// go install github.com/goweb/goyaml2
//
// Usage:
// import(
//   _ "github.com/cooleo/goweb/config/yaml"
//   "github.com/cooleo/goweb/config"
// )
//
//  cnf, err := config.NewConfig("yaml", "config.yaml")
//
//  more docs http://goweb.me/docs/module/config.md
package yaml
...
func (yaml *Config) ParseData(data []byte) (config.Configer, error) {
	...
	tmpName := path.Join(os.TempDir(), "goweb", fmt.Sprintf("%d", time.Now().Nanosecond()))
