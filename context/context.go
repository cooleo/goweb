...
// Context Http request context struct including gowebInput, gowebOutput, http.Request and http.ResponseWriter.
// gowebInput and gowebOutput provides some api to operate request and response more easily.
type Context struct {
	Input          *gowebInput
	Output         *gowebOutput
...
// if goweb.ErrorMaps exists, panic body.
...
// It's alias of gowebInput.Cookie.
func (ctx *Context) GetCookie(key string) string {
	return ctx.Input.Cookie(key)
}

// SetCookie Set cookie for response.
// It's alias of gowebOutput.Cookie.
