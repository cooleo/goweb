...
var indexTpl = `
{{define "content"}}
<h1>goweb Admin Dashboard</h1>
<p>
For detail usage please check our document:
</p>
<p>
<a target="_blank" href="http://goweb.me/docs/module/toolbox.md">Toolbox</a>
</p>
<p>
<a target="_blank" href="http://goweb.me/docs/advantage/monitor.md">Live Monitor</a>
</p>
{{.Content}}
{{end}}`
...
Welcome to goweb Admin Dashboard
