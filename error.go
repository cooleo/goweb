...
<head>
    ...
    <title>goweb application error</title>
    <style>
...
<body>
    ...
    <div id="footer">
        <p>goweb {{ .gowebVersion }} (goweb framework)</p>
...
func showErr(err interface{}, ctx *context.Context, stack string) {
	t, _ := template.New("goweberrortemp").Parse(tpl)
		...
		<div id="wrapper">
			<div id="container">
				...
				<div id="content">
					...
					<br>Powered by goweb {{.gowebVersion}}
				</div>
			</div>
		</div>
	</body>
...
func unauthorized(rw http.ResponseWriter, r *http.Request) {
	t, _ := template.New("goweberrortemp").Parse(errtpl)
...
// usage:
// 	goweb.ErrorHandler("404",NotFound)
//	goweb.ErrorHandler("500",InternalServerError)
...
// usage:
// 	goweb.ErrorController(&controllers.ErrorController{})
